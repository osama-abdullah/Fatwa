...
import { Icon, Text, TopNavigation, TopNavigationAction,List ,BottomNavigation,BottomNavigationTab} from '@ui-kitten/components';
...
export class FavoriteScreen extends React.Component {
  ...
  successDB() {
    ...
    db.transaction((tx) => {
      ...
      tx.executeSql('select * from fatawas where fav=1' , [], (tx, results) => {
        var temp = [];
